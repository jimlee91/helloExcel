...
document.querySelectorAll(".estimate__user-more").forEach(el => {
  el.addEventListener("click", function() {
    this.closest(".estimate__user")
      .querySelector(".js-innerToggle")
      .classList.toggle("show");
  });
});

document
  .querySelector(".topHistoryList__toggle")
...
// 변경이력 및 채팅 헤더 클릭시 토글
document.querySelectorAll(".main__Info .utilbox__header button").forEach(el => {
  el.addEventListener("click", function() {
